 ...
 * Expect detections to be *exceedingly rare* unless you run this on a something like a datacenter. If you have access to that kind of hardware you probably already know more about how cosmic rays affect it that this program will reveal.
